            ...
            <div className="row">
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> São Paulo</h5>
                ...
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> Rio de Janeiro</h5>
                ...
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> Recife</h5>
                ...
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> Salvador</h5>
                ...
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> Belo Horizonte</h5>
                ...
                <div className="col-md-2">
                    <div className="card">
                        ...
                        <div className="card-body  text-center">
                            <h5 className="card-title"><img src="/imagens/aviao.png"/> Porto Alegre</h5>
